...
class _ApiService implements ApiService {
  ...
  Future<UpdateUserInfoResponse> updateInfo(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updateUserInfo.toJson());
    final _options = _setStreamType<UpdateUserInfoResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VerifyCodeRegisterResponse> verifyCodeRegister(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(verifyCodeRegisterRequest.toJson());
    final _options = _setStreamType<VerifyCodeRegisterResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VerifyCodeRegisterResponse _value;
    try {
      _value = VerifyCodeRegisterResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<DeleteAccounResponse> deleteAccount(
    ...
    final _options = _setStreamType<DeleteAccounResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteAccounResponse _value;
    try {
      _value = DeleteAccounResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
