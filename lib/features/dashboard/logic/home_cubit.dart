...
class AddAdvertisementCubit extends Cubit<AddAdvertisementState> {
  ...
  final List<String> regions = [
    // محافظة العاصمة
    'مدينة الكويت', 'دسمان', 'الشرق', 'الصالحية', 'المرقاب', 'القبلة',
    'الصوابر', 'بنيد القار',
    'كيفان', 'الروضة', 'العديلية', 'النزهة', 'الفيحاء', 'الشامية', 'القادسية',
    'المنصورية',
    'الدعية', 'الشعب', 'الخالدية', 'اليرموك', 'قرطبة', 'السرة', 'الشويخ',
    'الري', 'غرناطة',
    'الصليبيخات', 'الدوحة', 'النهضة', 'مدينة جابر الأحمد', 'القيروان',
    'شمال غرب الصليبيخات',

    // محافظة حولي
    'حولي', 'السالمية', 'الرميثية', 'الجابرية', 'مشرف', 'بيان', 'البدع',
    'النقرة',
    'ميدان حولي', 'مبارك العبد الله (غرب مشرف)', 'سلوى', 'جنوب السرة',
    'الزهراء',
    'الصديق', 'السلام', 'حطين', 'الشهداء',

    // محافظة الفروانية
    'الفروانية', 'خيطان', 'الأندلس', 'الفردوس', 'الرقعي', 'العارضية',
    'العارضية الصناعية',
    'الرابية', 'الرحاب', 'العمرية', 'إشبيلية', 'جليب الشيوخ', 'صباح الناصر',
    'الشدادية',
    'ضاحية عبد الله المبارك', 'الضجيج',

    // محافظة الأحمدي
    'الأحمدي', 'الفنطاس', 'العقيلة', 'الظهر', 'المهبولة', 'الرقة', 'هدية',
    'أبو حليفة',
    'الصباحية', 'المنقف', 'الفحيحيل', 'الوفرة', 'الزور', 'الخيران',
    'مدينة صباح الأحمد',
    'مدينة الخيران البحرية', 'ضاحية جابر العلي', 'ضاحية فهد الأحمد',
    'علي صباح السالم (أم الهيمان)',

    // محافظة مبارك الكبير
    'مبارك الكبير', 'صباح السالم', 'المسيلة', 'العدان', 'القصور', 'القرين',
    'أبو الحصانية',
    ...
    'مدينة المطلاع', 'كبد', 'الصليبية', 'العبدلي', 'الصبية'
  ];
